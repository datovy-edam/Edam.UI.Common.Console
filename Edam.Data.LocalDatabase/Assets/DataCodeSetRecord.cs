   ...
   public class DataCodeSetRecord
   {
         ...
         int optionNo)
      {
         ...
         try
         {
            ...
            if (p.OpenReader())
            {
               rlog.Instance = DataReader.GetList<CodeSetInfo>(p.Reader);
               rlog.Succeeded();
            }
         }
         catch (Exception ex)
         ...
         string sessionId, CodeSetInfo codeSet, int optionNo)
      {
         ...
         try
         {
            ...
            if (p.OpenReader())
            {
               ...
               results.Instance = codeSet.CodeSetNo;
               results.Succeeded();
            }
         }
         catch (Exception ex)
         ...
         int optionNo)
      {
         ...
         try
         {
            ...
            if (p.OpenReader())
            {
               rlog.Instance = DataReader.GetList<CodeInfo>(p.Reader);
               rlog.Succeeded();
            }
         }
         catch (Exception ex)
