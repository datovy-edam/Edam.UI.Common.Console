   ...
   public class UserAccount
   {
      ...
      */
         ...
         LoginUser(App.ApplicationRequestContext context, Password password)
      {
         ...
         {
            response.SessionId = results.Instance.SessionId;
            response.RequestId = results.Instance.RequestId;
         }
         response.ResponseData = results.Instance;
         response.Status = (results.Instance != null) && (results.Success) ?
